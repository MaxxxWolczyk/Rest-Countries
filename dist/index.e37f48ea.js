...
var _mapsView = require("./mapsView");
var _mapsViewDefault = parcelHelpers.interopDefault(_mapsView);
var _detailsView = require("./detailsView");
var _detailsViewDefault = parcelHelpers.interopDefault(_detailsView);
const controllMapsView = async function() {
    //Loading all countries data from API
    await _model.loadAllCountries("all");
    //Rendering all countries
    _model.state.countries.forEach((el)=>(0, _mapsViewDefault.default).render(el));
    (0, _mapsViewDefault.default).addhandlerCards();
};
const controllRegion = async function(e) {
    ...
    await _model.loadAllCountries(`region/${e.target.value}`);
    (0, _mapsViewDefault.default).clear();
    _model.state.countries.forEach((el)=>{
        (0, _mapsViewDefault.default).render(el);
    });
    (0, _mapsViewDefault.default).addhandlerCards();
};
const controllInput = async function(e) {
    if (e.target.value.length <= 0) controllMapsView();
    await _model.loadAllCountries(`${e.target.value ? `name/${e.target.value}` : "all"}`);
    (0, _mapsViewDefault.default).clear();
    _model.state.countries.forEach((el)=>(0, _mapsViewDefault.default).render(el));
    (0, _mapsViewDefault.default).addhandlerCards();
};
const controllDetail = async function(data) {
    if (!data) return;
    (0, _detailsViewDefault.default).renderSpinner();
    await _model.loadAllCountries(`name/${data}`);
    (0, _detailsViewDefault.default).renderDetail(_model.state);
    (0, _mapsViewDefault.default).addhandlerCards();
};
const controllDetailbtn = async function(data) {
    if (!data) return;
    (0, _detailsViewDefault.default).renderSpinner();
    await _model.loadAllCountries(`alpha/${data}`);
    (0, _detailsViewDefault.default).renderDetail(_model.state);
    (0, _mapsViewDefault.default).addhandlerCards();
};
const init = function() {
    (0, _mapsViewDefault.default).darkmode();
    (0, _mapsViewDefault.default).addHandlerRender(controllMapsView);
    (0, _mapsViewDefault.default).addHandlerChange(controllRegion);
    (0, _mapsViewDefault.default).addHandlerSearch(controllInput);
    (0, _detailsViewDefault.default).addHandlerClose();
    (0, _detailsViewDefault.default).addHandlerGetInfo(controllDetail);
    (0, _detailsViewDefault.default).addHandlerBorder(controllDetailbtn);
};
init();

},{"./model":"Y4A21","./mapsView":"gkvGp","./detailsView":"b8L0k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadAllCountries", ()=>loadAllCountries);
...
const loadAllCountries = async function(field = "all") {
    const data = await getJSON(URL, field);
    state.countries = data;
    console.log(state);
    if (state.names.length === 0) data.forEach((el)=>state.names.push({
            name: el.name.common,
            fifa: el.fifa
        }));
};
...
},{}],"gkvGp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class MapView {
    ...
    darkmode() {
        ...
        this._darkModeBtn.addEventListener("click", (function() {
            if (this._switch) {
    ...
    addhandlerCards() {
        ...
        cards.forEach((el)=>{
            (0, _detailsViewDefault.default).addHandlerShow(el);
        });
    }
...
},{"./detailsView":"b8L0k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../images/icons.svg":"hXnY3"}],"b8L0k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _mapsView = require("./mapsView");
var _mapsViewDefault = parcelHelpers.interopDefault(_mapsView);
...
class DetailView {
    ...
    _generateDetail(data) {
        const detailMarkup = data.countries[0].borders.map((el)=>{
            let fullname = data.names.find((item)=>item.fifa === el);
            if (fullname === undefined) return `<button class="view-card__btn btn-detail btn" data-name ="${el}">${el}</button>`;
    ...
    <div class="view-card__details">
      ...
      <div class="view-card__description">
        <p class="view-card__item">Native Name: <span>${data.countries[0].name.official}</span></p>
        <p class="view-card__item">Population: <span>${this.numebrFormat(data.countries[0].population)}</span></p>
        <p class="view-card__item">Region: <span>${data.countries[0].region}</span></p>
        <p class="view-card__item">Sub Region: <span>${data.countries[0].subregion}</span></p>
        <p class="view-card__item">Capital: <span>${data.countries[0].capital ? data.countries[0].capital : "Nothing found"}</span></p>
        <p class="view-card__item">Top Level Domain: <span>${data.countries[0].fifa}</span></p>
        <p class="view-card__item">Currencies: <span>${data.countries[0].currencies ? Object.values(data.countries[0].currencies)[0].name : "Nothing found"}</span></p>
        <p class="view-card__item">Languages: <span>${Object.values(data.countries[0].languages)[0]}</span></p>
      </div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./mapsView":"gkvGp","url:../images/icons.svg":"hXnY3"}],"hXnY3":[function(require,module,exports) {
module.exports = require("f80028d949f66ddc").getBundleURL("hWUTQ") + "icons.548cde10.svg" + "?" + Date.now();

},{"f80028d949f66ddc":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["d8XZh","aenu9"], "aenu9", "parcelRequire1861")
